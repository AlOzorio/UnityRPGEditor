...
namespace UnityRPGEditor.Editor
{
    ...
    public class CreateNewAsset
    {
        ...
        {
            // we're using reflection to analyze a class, find a specific private function, and the call it
            // we do this to gain editor functionality we don't normally have access
